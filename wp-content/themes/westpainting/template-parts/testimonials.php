<div id="testimonials">
	<h1 class="yellowtext">Client<br>
		<span class="greytext">Testimonials</span>
	</h1>
	<div class="slider testimonials">
		<div>
			...
			<!-- <img src="<?php //echo esc_url( home_url( '/wp-content/themes/westpainting/inc/quote-right.svg' ) ); ?>"> -->
